...
<%
    ...
    for bid in tasks:
        for t in tasks[bid]:
            teams = ['unknown'] if t['team'] == '' else t['team']
            for team in teams:
            ...
            <div>
                ...
                <table width="100%%" cellspacing="0" cellpadding="0">
                    ...
                    <tbody>
                        ...
                        <tr><td>Fixes     </td><td>Icons indicating if the bug has a patch or branch.                   </td></tr>
                    </tbody>
                </table>
                <br />
            </div>
                    ...
                    */
                    ...
                    if (!fail) {
                        ...
                        $.each(task.team, function(index, team) {
                            ...
                            s += "<td>";
                            if (task.bug.latest_patch_uploaded != 'None') {
                                s += 'P ';
                            }
                            if (task.bug.linked_branches.length >= 1) {
                                s += 'B ';
                            }
                            s += '</td>';
                            s += "</tr>";
