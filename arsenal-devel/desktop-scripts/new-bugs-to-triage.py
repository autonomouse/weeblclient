...
def setup_page(page, since_when, title, packages):
    ...
    for line in templatefile:
		...
		# excluding bugs waiting to be retraced.
                for task in source_package.searchTasks(created_since=since_when, status='New', tags=['-need-i386-retrace', '-need-amd64-retrace'], tags_combinator='All', order_by='-heat'):
...
setup_page('new-bugs-since-24hours.html', twentyfour, 'Desktop New bugs since 24 hours', desktop_packages)
setup_page('new-bugs-since-7days.html', oneweek, 'Desktop New bugs since 7 days', desktop_packages)
