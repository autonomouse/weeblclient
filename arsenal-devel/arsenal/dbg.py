...
class Dbg:
    ...
    def enter(cls, txt):
        """
        Print a debug message preceded by 'Enter'.
        """
    ...
    def leave(cls, txt):
        """
        Print a debug message preceded by 'Leave'.
        """
    ...
    def ret(cls, txt, result):
        """
        Print a debug message preceded by 'Return'.
        """
        if 'leave' in cls.levels:
            cls.indent_level -= 1
    ...
    def warn(cls, txt):
        """
        Print a debug message preceded by 'Warning:'.
        """
    ...
    def error(cls, txt):
        """
        Print a debug message preceded by 'Error:'.
        """
