...
/// @link         http://ubuntudesign.github.io/vanilla-framework/docs/#mixin-vf-typography
/// @since        0.0.3
////
...
@mixin vf-typography {
  @font-face {
    ...
    font-style: normal;
    font-weight: 300;
    src: url('#{$asset-path}fonts/ubuntu-l-webfont.woff') format('woff');
  }
  ...
  @font-face {
    ...
    font-style: normal;
    font-weight: 400;
    src: url('#{$asset-path}fonts/ubuntu-r-webfont.woff') format('woff');
  }
